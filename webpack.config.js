...
const HtmlWebpackPlugin = require('html-webpack-plugin'); // подключите HtmlWebpackPlugin
const { CleanWebpackPlugin } = require('clean-webpack-plugin'); // подключили CleanWebpackPlugin
